...
// Modules required by grub in order to boot HeisenOs
char* GrubModules[] = {
...
{
    TextGUI::ClearScreen(VGA_COLOR_BLUE);
    TextGUI::DrawString("Select a disk to install HeisenOs to:", 0, 0);
...
{
    TextGUI::ClearScreen();
    TextGUI::DrawString("You are about to start the installation of HeisenOs to your hard drive", 0, 0);
...
void Installer::CreateFatPartition(PartitionTableEntry* pEntry)
{
    ...
    MemoryOperations::memcpy(biosParameterBlock.Oem_Id, "HeisenOs", 8);
    ...
    MemoryOperations::memcpy(biosParameterBlock.VolumeLabel, "HeisenOs HD", 11);
