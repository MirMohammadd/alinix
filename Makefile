...
G++PARAMS := -m32 -g -D Alinix -I $(INCLUDEDIRS) -I arch/mips/include -Wall -fno-omit-frame-pointer -fno-use-cxa-atexit -nostdlib -fno-builtin -fno-exceptions -fno-rtti -fno-leading-underscore -Wno-write-strings -fpermissive -Wno-unknown-pragmas -lgcc -L/usr/lib/gcc/i686-elf/10.2.0/
GCCPARAMS := -m32 -g -D Alinix -I $(INCLUDEDIRS) -I arch/mips/include -Wall -fno-omit-frame-pointer -nostdlib -fno-builtin -Wno-unknown-pragmas -lgcc -L/usr/lib/gcc/i686-elf/10.2.0/
ASPARAMS := --32
LDPARAMS := -m elf_i386
