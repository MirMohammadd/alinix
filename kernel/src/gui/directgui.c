...
MODULE_DESCRIPTION("Direct GUI for kernel interface")
...
/**
 * Requests a new framebuffer from the system.
 *
 * @return True if the framebuffer was successfully requested, false otherwise.
 *
 * @throws None
 */
