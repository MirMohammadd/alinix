...
/**
 * @abstraction:
 *  - Graphical model header file implementation.
...
/**
 * @brief Useful macros for graphical settings drivers.
*/
...
#define DISPLAY_CS(state)					(state ? BIT_13 : BIT_13)		//0 = Select Controller
#define DISPLAY_REGISTER_SELECT(state)		(state ? BIT_10 : BIT_10)		//0 = Command, 1 = Data
#define	DISPLAY_RESET(state)				(state ? BIT_10 : BIT_10)		//0 = Reset Controller
