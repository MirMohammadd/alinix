...
*/
#ifndef __UCAPI_REGISTERS_INCLUDED__H
#define __UCAPI_REGISTERS_INCLUDED__H
...
uacpi_status uacpi_read_register(enum uacpi_register, u64*);
...
uacpi_status uacpi_read_register_field(enum uacpi_register_field, u64*);
