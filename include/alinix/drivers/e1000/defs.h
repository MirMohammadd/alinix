...
/**
 * @abstract:
 *  - defs for the drivers kernel.
*/

#ifndef __ALINIX_KERNEL_DRIVERS_NET_E1000_H_DEFS
#define __ALINIX_KERNEL_DRIVERS_NET_E1000_H_DEFS


/**
 * @ref https://github.com/merlinrebrovic/e1000e/blob/master/src/defines.h
*/
